<template>
  <div class="editTechnicianAccount">
    <br /><br />
    ...
    <button
      @click="goToViewTechnicianAccount()"
      type="button"
    ...
    <button
      @click="updateTechnicianAccount(newPassword, confirmPassword, newName)"
      type="button"
...
<script  src="./editTechnicianAccount.js">
</script>
