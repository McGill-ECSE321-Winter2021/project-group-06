...
public class TechnicianAccountController {
	 ...
	 */
	@GetMapping(value = { "/technicianAccounts", "/technicianAccounts/" })
	 ...
	 */
	@GetMapping(value = { "/technicianAccount/{username}", "/technicianAccount/{username}/" })
	 ...
	 * @return list of Technician Dtos
	 */
	@GetMapping(value = { "/technicianAccounts/{name}", "/technicianAccounts/{name}" })
	 ...
	 */
	@PostMapping(value = { "/technicianAccount/{username}/{password}/{name}", "/technicianAccount/{username}/{password}/{name}/" })
