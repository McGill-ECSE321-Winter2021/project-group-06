...
public class Car
{
  ...
  public Appointment addAppointment(Time aStartTime, Time aEndTime, Date aStartDate, Date aEndDate, String aComment, Garage aGarage, Service aService, TimeSlot aTimeSlot, Technician... allWorker)
  {
    return new Appointment(aStartTime, aEndTime, aStartDate, aEndDate, aComment, this, aGarage, aService, aTimeSlot, allWorker);
  }
